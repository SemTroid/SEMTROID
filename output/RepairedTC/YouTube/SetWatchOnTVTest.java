...
public class SetWatchOnTVTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.widget.TextView[@text=\"Watch on TV\"]").click();
        driver.findElementById("com.google.android.youtube:id/enter_tv_code_text_field").click();
    }
