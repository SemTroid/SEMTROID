...
public class ShareMatchTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.widget.ListView[@resource-id='android:id/resolver_list']/android.widget.LinearLayout[2]/android.widget.LinearLayout[2]/android.widget.FrameLayout[1]/android.widget.ImageView[1]").click();
