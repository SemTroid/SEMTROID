...
public class FollowAndUnfollowTeamTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//androidx.recyclerview.widget.RecyclerView[@resource-id='com.mobilefootie.wc2010:id/recyclerView_historyAndSuggestions']/android.widget.LinearLayout[8]/android.widget.CompoundButton[1]").click();
        driver.findElementById("com.mobilefootie.wc2010:id/menu_edit").click();
        driver.findElementByXPath("//android.widget.GridView[@resource-id='com.mobilefootie.wc2010:id/recyclerView']/androidx.cardview.widget.CardView[3]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]").click();
        driver.findElementById("com.mobilefootie.wc2010:id/menu_edit").click();
    }
