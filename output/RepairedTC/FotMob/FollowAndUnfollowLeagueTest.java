...
public class FollowAndUnfollowLeagueTest {
    ...
    public void sampleTest() throws InterruptedException {
        driver.findElementByXPath("//android.widget.FrameLayout[@content-desc=\"Leagues\"]/android.widget.FrameLayout[1]/android.widget.ImageView[1]").click();
        ...
        driver.findElementByXPath("//android.widget.TextView[@resource-id='com.mobilefootie.wc2010:id/txtLeague' and @text=\"Champions League\"]").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Player stats\"]").click();
        driver.findElementByXPath("//android.widget.Button[@text=\"Following\"]").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Harry Kane\"]").click();
    }
