...
public class FollowAndUnfollowTopicTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.support.v7.widget.RecyclerView[@resource-id='com.google.android.apps.magazines:id/recycler_view']/android.widget.LinearLayout[1]/android.widget.ImageView[1]").click();
        driver.findElementByXPath("//android.support.v7.widget.RecyclerView[@resource-id='com.google.android.apps.magazines:id/recycler_view']/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.TextView[1]").click();
