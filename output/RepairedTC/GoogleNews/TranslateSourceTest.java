...
public class TranslateSourceTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementById("com.google.android.apps.magazines:id/open_search_view_edit_text").sendKeys("Maxim");
        driver.findElementByXPath("//android.support.v7.widget.RecyclerView[@resource-id='com.google.android.apps.magazines:id/recycler_view']/android.widget.LinearLayout[8]/android.widget.LinearLayout[1]/android.widget.TextView[1]").click();
