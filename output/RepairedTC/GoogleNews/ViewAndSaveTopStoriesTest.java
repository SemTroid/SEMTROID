...
public class ViewAndSaveTopStoriesTest {
    ...
    public void sampleTest() throws InterruptedException {
        driver.findElementByXPath("//android.widget.Button[@content-desc=\"Top stories\"]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.ImageView[1]").click();
        driver.findElementById("com.google.android.apps.magazines:id/more_button").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Save for later\"]").click();
    }
