...
public class HealthDeleteTest {
    ...
    public void sampleTest() {
        ...
        driver.findElementByXPath("//android.support.v7.widget.RecyclerView[@resource-id='bbc.mobile.news.uk:id/recyclerview']/android.widget.RelativeLayout[1]/android.widget.ImageView[1]").click();
    }
