...
public class AdjustSettingsTest {
    ...
    public void sampleTest() throws InterruptedException {
        driver.findElementById("com.google.android.apps.translate:id/logo").click();// 修复错误
        driver.findElementByXPath("//android.widget.TextView[@text=\"Settings\"]").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Tap to Translate\"]").click();
