...
public class ViewTrendingTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.view.ViewGroup[@content-desc=\"Gaming\"]/android.widget.ImageView[1]").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Music\"]").click();
    }
