...
public class SixteenTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.widget.TextView[@text=\"Search\"]").clear();
        driver.findElementById("android:id/search_src_text").sendKeys("init01.png");
        driver.findElementById("org.openintents.filemanager:id/primary_info").click();
