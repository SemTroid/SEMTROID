...
public class SevenTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByAccessibilityId("More options").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Rename\"]").click();
        driver.findElementById("org.openintents.filemanager:id/foldername").clear();
        driver.findElementById("org.openintents.filemanager:id/foldername").sendKeys("init00.png");
