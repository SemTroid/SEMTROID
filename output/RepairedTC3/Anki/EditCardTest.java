...
public class EditCardTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.widget.TextView[@text=\"Edit note\"]").click();
        driver.findElementByAccessibilityId("More options").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Add note\"]").click();
        driver.findElementByXPath("//android.widget.EditText[@content-desc=\"Front\"]").clear();
        driver.findElementByXPath("//android.widget.EditText[@content-desc=\"Front\"]").sendKeys("TestFront15");
        driver.findElementByXPath("//android.widget.EditText[@content-desc=\"Back\"]").clear();
        driver.findElementByXPath("//android.widget.EditText[@content-desc=\"Back\"]").sendKeys("TestBack15");
        driver.findElementById("com.ichi2.anki:id/action_save").click();
        driver.findElementByAccessibilityId("More options").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Copy note\"]").click();
        driver.findElementById("com.ichi2.anki:id/action_save").click();
        driver.findElementByAccessibilityId("More options").click();
        //;
        //;
