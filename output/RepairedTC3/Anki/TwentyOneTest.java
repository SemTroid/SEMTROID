...
public class TwentyOneTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.widget.CheckedTextView[@text=\"Night mode\"]").click();
        driver.findElementByAccessibilityId("Navigate up").click();
        driver.findElementByXPath("//android.widget.CheckedTextView[@text=\"Help\"]").click();
        driver.navigate().back();
        driver.findElementByAccessibilityId("Navigate up").click();
        driver.findElementByXPath("//android.widget.CheckedTextView[@text=\"Send feedback\"]").click();
        driver.navigate().back();
    }
