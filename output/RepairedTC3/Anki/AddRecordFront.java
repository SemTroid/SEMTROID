...
public class AddRecordFront {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.widget.TextView[@text=\"Record audio\"]").click();
        driver.findElementByXPath("//android.widget.LinearLayout[@resource-id='com.ichi2.anki:id/LinearLayoutInScrollViewFieldEdit']/android.widget.LinearLayout[1]/android.widget.ImageButton[3]").click();
        driver.findElementByXPath("//android.widget.LinearLayout[@resource-id='com.ichi2.anki:id/LinearLayoutInScrollViewFieldEdit']/android.widget.LinearLayout[1]/android.widget.ImageButton[3]").click();
        ...
        driver.findElementByXPath("//android.widget.EditText[@content-desc=\"Back\"]").sendKeys("TestBack7");
