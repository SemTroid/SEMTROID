...
public class TwentyFiveTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.widget.TextView[@text=\"Swipe sensitivity\"]").click();
        driver.navigate().back();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Swipe up\"]").click();
        driver.findElementByXPath("//android.widget.CheckedTextView[@text=\"Answer button 1\"]").click();
        driver.navigate().back();
        driver.findElementByAccessibilityId("Navigate up").click();
        driver.findElementByAccessibilityId("Navigate up").click();
