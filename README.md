...
The repository stores our implementations for the approach **SEMTROID** .
...
- [BikeWale](https://apkpure.com/cn/bikewale-bikes-two-wheelers/com.bikewale.app)
- [Blood Pressure Tracker](https://apkpure.com/cn/blood-pressure-tracker/com.bloodpressurechecker.bpmonitor.bptracker)
- [Where is my Train](https://apkpure.com/cn/where-is-my-train/com.whereismytrain.android)
- [ReadEra](https://apkpure.com/cn/readera-%E2%80%93-book-reader-pdf-epub/org.readera)
- [MyNetDiary](https://mynetdiary.cn.uptodown.com/android)
- [Open Camera](https://apkpure.com/cn/open-camera/net.sourceforge.opencamera)
...
The semantic model fine-tuning code `train.py`, the dataset folder `data` and label file `label.csv` used for semantic model fine-tuning are in the directory `resource.vit`.
