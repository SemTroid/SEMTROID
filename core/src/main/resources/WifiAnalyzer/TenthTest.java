...
public class TenthTest {
    ...
    public void sampleTest() throws InterruptedException{
        ...
        driver.findElementByXPath("(//*[@resource-id='com.vrem.wifianalyzer:id/design_menu_item_text'])[9]").click();
        driver.findElementById("com.vrem.wifianalyzer:id/contributors").click();
        driver.findElementById("android:id/button3").click();
        driver.findElementById("com.vrem.wifianalyzer:id/writeReview").click();
