...
public class EighthTest {
    ...
    public void sampleTest() throws InterruptedException{
        ...
        driver.findElementByXPath("(//*[@resource-id='com.vrem.wifianalyzer:id/design_menu_item_text'])[7]").click();
        driver.findElementById("android:id/search_src_text").sendKeys("test");
