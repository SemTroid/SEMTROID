...
public class SevenTest {
    ...
    public void sampleTest() throws InterruptedException{
        ...
        driver.findElementById("com.android.gallery3d:id/action_cancel").click();
        ...
        driver.findElementByXPath("(//*[@resource-id='com.ichi2.anki:id/id_note_editText'])[1]").sendKeys("TestFront9");
        ...
        driver.findElementById("com.ichi2.anki:id/multimedia_edit_field_done").click();
        driver.findElementByXPath("(//*[@resource-id='com.ichi2.anki:id/id_note_editText'])[1]").clear();
        driver.findElementByXPath("(//*[@resource-id='com.ichi2.anki:id/id_note_editText'])[1]").sendKeys("TestFront10");
        driver.findElementById("com.ichi2.anki:id/action_save").click();
