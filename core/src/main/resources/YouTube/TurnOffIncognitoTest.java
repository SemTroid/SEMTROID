...
/*
    ...
    breakage: 40 匿名头像 定位不到   41 Incognito 定位不到
 */
public class TurnOffIncognitoTest {
    ...
    public void sampleTest() throws InterruptedException {
        ...
        driver.findElementByXPath("//android.widget.TextView[@resource-id=\"com.google.android.youtube:id/title\" and @text=\"Turn off Incognito\"]").click();
    }
