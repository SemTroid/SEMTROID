...
public class BusinessDeleteTest {
    ...
    public void sampleTest() {
        ...
        driver.findElementByXPath("//android.widget.FrameLayout[@content-desc=\"Button: Unfollow Business\"]/android.widget.LinearLayout/android.widget.ImageView[1]").click();
    }
