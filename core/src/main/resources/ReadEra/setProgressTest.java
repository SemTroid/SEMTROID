...
//        driver.manage().timeouts().implicitlyWait(IMPLICIT_WAIT, TimeUnit.SECONDS); // 添加隐式等待
    ...
    @Test
    public void setProgressFunction() throws InterruptedException {
        Thread.sleep(1000);
        ...
        Thread.sleep(1000);
        driver.findElementByXPath("//android.widget.TextView[@resource-id='android:id/title' and @text='Flipping settings']").click();
        Thread.sleep(1000);
        driver.findElementByXPath("(//android.widget.TextView[@resource-id='android:id/title'])[12]").click();
        Thread.sleep(1000);
        driver.findElementByXPath("//android.widget.CheckedTextView[@resource-id='android:id/text1' and @text='Percent read']").click();
        Thread.sleep(1000);
    }
