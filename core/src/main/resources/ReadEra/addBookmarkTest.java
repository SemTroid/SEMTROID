...
//        driver.manage().timeouts().implicitlyWait(IMPLICIT_WAIT, TimeUnit.SECONDS); // 添加隐式等待
    ...
    @Test
    public void addBookmarkFunction() throws InterruptedException {
...
//            driver.findElement(AppiumBy.id("com.android.packageinstaller:id/permission_allow_button")).click();
        ...
        Thread.sleep(1000);
        driver.findElementByAccessibilityId("Bookmarks").click();
        Thread.sleep(1000);
        driver.findElementById("org.readera:id/bookmark_add").click();
        Thread.sleep(1000);
